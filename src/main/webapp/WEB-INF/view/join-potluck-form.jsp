	...
	<div>
		...
		<div id="loginbox"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					<form:form action="joinPotluck" method="POST" class="login100-form validate-form" modelAttribute="potluck">
						<form:hidden path="id"/>
					    ...
					    <div class="wrap-input100 validate-input m-b-23">
							...
							<form:input path="inviteCode" class="input100" type="text" placeholder="abc123"/>
						...
						<a href=${pageContext.request.contextPath}/myjoinedpotlucks class="txt2">
							Cancel
						</a>
					</div>
